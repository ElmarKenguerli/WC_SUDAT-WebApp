...
function DataTable() {
  ...
  const columns = [
    ...
    { field: 'Edit', headerClassName: 'col--header', headerName: 'Edit', minWidth: 110, renderCell: renderEditButton, flex: 1 },
    { field: 'Report', headerClassName: 'col--header', headerName: 'Report', minWidth: 110, renderCell: renderReportButton, flex: 1 }
  ];
